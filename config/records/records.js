export const playerRecords = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'timeZeroBoost', label: '0 Boost (s)', isTime: true },
      { id: 'timeBoost0To25', label: '0-25 Boost (s)', isTime: true },
      { id: 'timeBoost25To50', label: '25-50 Boost (s)', isTime: true },
      { id: 'timeBoost50To75', label: '50-75 Boost (s)', isTime: true },
      { id: 'timeBoost75To100', label: '75-100 Boost (s)', isTime: true },
      { id: 'timeFullBoost', label: '100 Boost (s)', isTime: true },
    ],
  },
  {
    label: 'Movement',
    items: [
      ...
      { id: 'timeSupersonicSpeed', label: 'Supersonic Speed (s)', isTime: true },
      { id: 'timeBoostSpeed', label: 'Boost Speed (s)', isTime: true },
      { id: 'timeSlowSpeed', label: 'Slow Speed (s)', isTime: true },
      { id: 'timeGround', label: 'On Ground (s)', isTime: true },
      { id: 'timeLowAir', label: 'In Low Air (s)', isTime: true },
      { id: 'timeHighAir', label: 'In High Air (s)', isTime: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'timeDefensiveThird', label: 'In Defensive 1/3 (s)', isTime: true },
      { id: 'timeNeutralThird', label: 'In Middle 1/3 (s)', isTime: true },
      { id: 'timeOffensiveThird', label: 'In Offensive 1/3 (s)', isTime: true },
      { id: 'timeDefensiveHalf', label: 'In Defensive 1/2 (s)', isTime: true },
      { id: 'timeOffensiveHalf', label: 'In Offensive 1/2 (s)', isTime: true },
      { id: 'timeBehindBall', label: 'Behind Ball (s)', isTime: true },
      { id: 'timeInfrontBall', label: 'In Front Of Ball (s)', isTime: true },
      { id: 'timeMostBack', label: 'Most Back (s)', isTime: true },
      { id: 'timeMostForward', label: 'Most Forward (s)', isTime: true },
      { id: 'timeClosestToBall', label: 'Closest To Ball (s)', isTime: true },
      { id: 'timeFarthestFromBall', label: 'Farthest From Ball (s)', isTime: true },
    ],
  },
  {
    label: 'Demolitions',
...
export const gameRecords = [
  ...
  {
    label: 'Duration',
    items: [{ id: 'duration', label: 'Duration', isTime: true }],
  },
]
