...
const MatchInfo = (props) => {
    ...
    const { date, blueTeam, blueTeamGoals, blueTeamWins,
        orangeTeam, orangeTeamWins, orangeTeamGoals
    } = props;

    return <Flex marginTop="1rem" width="100%" padding="0.5rem" align="center" flexDirection="column" border="1px solid #ddd" shadow="0 3px 5px rgba(0,0,0,.15)"
