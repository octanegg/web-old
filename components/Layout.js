...
const SideNav = ({ children }) => {
  return (
    <Flex height="400px" width="15%" backgroundColor="#b8bec6" margin="2rem" display={{ base: "none", lg: "block" }}>
      {children}
    </Flex>
  );
};
...
export const Content = ({ children, leftNav, rightNav }) => {
  return (
    <Flex width={{ base: "95%", xl: "60%" }} mt="2rem" backgroundColor="white" border="1px solid #ccc" justify="space-between">
